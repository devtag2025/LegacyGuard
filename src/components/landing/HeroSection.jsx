...
export function HeroSection() {
  return (
    ...
    >
      ...
      {/* Particle animation — right-biased mask */}
      <div
        aria-hidden="true"
        className="absolute inset-0 pointer-events-none z-0 opacity-50"
        style={{
          maskImage:       "radial-gradient(ellipse 70% 90% at 68% 40%, black 20%, transparent 78%)",
          WebkitMaskImage: "radial-gradient(ellipse 70% 90% at 68% 40%, black 20%, transparent 78%)",
        }}
      >
        <ParticleAnimation />
      </div>
      ...
      <div
        ...
        style={{
          backgroundImage: "linear-gradient(var(--color-cadet) 1px,transparent 1px),linear-gradient(90deg,var(--color-cadet) 1px,transparent 1px)",
      ...
      <div
        ...
        style={{
          background: "radial-gradient(ellipse at center,rgba(157,180,192,0.05) 0%,transparent 70%)",
        }}
      />
      ...
      {/* ── Content ── */}
      <div className="container-brand relative z-10 flex flex-col justify-center min-h-dvh pt-[calc(10px+2.5rem)] pb-14">
        ...
        <div className="flex flex-col lg:flex-row lg:items-start lg:gap-14">
          ...
          <div className="flex flex-col lg:flex-1">
            ...
            {/* Headline */}
            <h1 className="font-monument text-frosted leading-[1.1] tracking-[-0.02em] mb-6 text-[clamp(1.6rem,2.8vw,2.55rem)]">
            ...
            {/* Subtext */}
            <p className="font-sans text-frosted/60 text-[0.95rem] leading-[1.75] mb-5 max-w-[460px]">
              Our assessment helps you understand what
              your situation actually requires.
            </p>

            {/* Emotional anchor */}
            <p className="font-monument font-light text-frosted/55 text-[0.88rem] leading-[1.65] mb-8 max-w-[440px] border-l-2 border-cadet/20 pl-4">
              The decisions you make today will shape what your family
              receives — and how.
            </p>

            {/* Sense check — mobile only (between anchor and CTAs) */}
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3 mb-8">
              ...
              <a
                href="/book"
                className="font-sans text-cadet/70 text-[0.82rem] tracking-wide hover:text-cadet transition-colors"
            ...
            {/* Trust signals */}
            <ul className="flex flex-wrap gap-x-6 gap-y-2" role="list" aria-label="Trust indicators">
              {[
                ...
                <li key={t} className="flex items-center gap-2">
                  <svg width="10" height="10" viewBox="0 0 12 14" fill="none" aria-hidden="true">
                    <path
                      d="M6 0L7.5 4.5H12L8.5 7L10 12L6 9.5L2 12L3.5 7L0 4.5H4.5L6 0Z"
                      stroke="#9DB4C0" strokeWidth="1" fill="none" strokeLinejoin="round"
                    />
                  </svg>
                  <span className="font-sans text-[0.7rem] tracking-wide text-cadet/65">{t}</span>
                </li>
              ))}
            </ul>
          </div>

          {/* ── RIGHT — Sense check card — desktop only ── */}
      ...
      <div
        ...
        style={{
          background: "linear-gradient(to right,transparent,rgba(157,180,192,0.25),transparent)",
        }}
      />
    </section>
  );
    ...
    >
      ...
      <div className="px-6 py-4 flex items-center gap-3 border-b border-cadet/[0.08]">
        ...
        <span className="relative flex h-2 w-2 flex-shrink-0">
          <span className=" absolute inline-flex h-full w-full rounded-full bg-frosted opacity-60" />
          <span className="relative inline-flex h-2 w-2 rounded-full bg-frosted" />
        </span>
      ...
      <div className="px-6 py-4 border-t border-cadet/[0.08]">
        <p className="font-sans text-cadet/55 text-[0.82rem] leading-[1.65] italic">
          If any of these apply, it's worth understanding your situation
